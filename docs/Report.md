...
In conclusion, among the 12 different elections that were here analysed, the center parties had the majority of votes only in 3 occassions (1983 - 1987 - 1991). This does not provide enought evidence to confirm the theory of the "Median Voter". 

Also, the center parties ware the ones with the smallest share of votes in the last *six elections*. It is also interesting to notiche that through all the years considered, the results for the left and the center are always more similar to each other than they are to the results of the right. Could it be that the left and the center have more similar features, programs and opinions? 
